...
public interface TypeConverter {
   ...
   * 
   * @param conversionContext the value conversion context, not null
   ...
   */
  Map<JavaTypeInfo<?>, Integer> getConversionsTo(ValueConversionContext conversionContext, JavaTypeInfo<?> targetType);
   ...
   * <p>
   * Only one converter with any given key is allowed in a chain. This is enforced by the aggregator so that a language binding can override conversions already provided.
   * 
