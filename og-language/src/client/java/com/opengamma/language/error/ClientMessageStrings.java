...
public interface ClientMessageStrings {
   ...
   */
  ClientMessageStrings QUOTED_FORM = new QuotedClientMessageStrings();

  /**
   * Applies no quoting to string values.
   */
  ClientMessageStrings UNQUOTED_FORM = new DefaultClientMessageStrings();

  /**
   * Produces a summary form, discarding much of the original information in the interests of brevity.
   */
  ClientMessageStrings SIMPLE_FORM = new SimpleClientMessageStrings();
