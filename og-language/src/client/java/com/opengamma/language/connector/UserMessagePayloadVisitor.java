...
/**
 * Defines a visitor interface for the incoming user messages. Further visitor interfaces may be defined around these top-level messages to allow additional message-specific processing.
 * 
