...
public class ViewClientsTest {
  ...
  public void testLockView() {
    ...
    final ViewClientKey vck = new ViewClientKey(ViewClientDescriptor.tickingMarketData(VIEW_ID, (String) null), true);
    ...
    final ViewClientHandle handle2 = context.getUserContext().getViewClients().lockViewClient(new ViewClientKey(ViewClientDescriptor.tickingMarketData(VIEW_ID, (String) null), true));
  ...
  public void testUnlockUnlock() {
    final SessionContext context = createTestUtils().createSessionContext();
    final ViewClientHandle handle = context.getUserContext().getViewClients().lockViewClient(new ViewClientKey(ViewClientDescriptor.tickingMarketData(VIEW_ID, (String) null), true));
    handle.unlock();
    handle.unlock();
  }
