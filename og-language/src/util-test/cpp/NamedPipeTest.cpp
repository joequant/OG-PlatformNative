...
BEGIN_TESTS (NamedPipeTest)
	UNIT_TEST (ClientToServerComplete)
	UNIT_TEST (ClientToServerTimeoutConnectServer)
	UNIT_TEST (ClientToServerTimeoutConnectClient)
	UNIT_TEST (ClientToServerTimeoutReadServer)
	UNIT_TEST (ClientToServerTimeoutWriteClient)
	UNIT_TEST (ServerToClientComplete)
	UNIT_TEST (ServerToClientTimeoutConnectServer)
	UNIT_TEST (ServerToClientTimeoutConnectClient)
	UNIT_TEST (ServerToClientTimeoutWriteServer)
	UNIT_TEST (ServerToClientTimeoutReadClient)
	UNIT_TEST (ClientToServerCloseServer)
	UNIT_TEST (ClientToServerCloseClient)
	UNIT_TEST (ServerToClientCloseServer)
	UNIT_TEST (ServerToClientCloseClient)
	UNIT_TEST (ClientToServerLazyCloseServer)
	UNIT_TEST (ClientToServerLazyCloseClient)
	UNIT_TEST (ServerToClientLazyCloseServer)
	UNIT_TEST (ServerToClientLazyCloseClient)
	UNIT_TEST (ClientToServerCancelLazyCloseServer)
	UNIT_TEST (ClientToServerCancelLazyCloseClient)
	UNIT_TEST (ServerToClientCancelLazyCloseServer)
	UNIT_TEST (ServerToClientCancelLazyCloseClient)
	UNIT_TEST (RepeatedOperation)
	UNIT_TEST (ServerWriteExclusive)
	UNIT_TEST (ServerReadExclusive)
END_TESTS
